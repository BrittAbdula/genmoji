...
const styleCategories = [
  ...
  },
  {
    id: 'chibi',
    name: 'Chibi',
    description: 'Cute mini-character style with oversized expressions',
    ...
    subStyles: [],
    seoTitle: 'Chibi Genmoji Generator - Cute Mini Character Custom Emojis',
    seoDescription: 'Create adorable chibi-style genmojis with cute proportions, expressive faces, and playful character energy.',
    features: [
      'Cute mini-character proportions',
      'Expressive oversized facial features',
      'Playful and friendly style',
      'Great for community avatars and stickers',
    ],
  },
  {
    id: 'plushie',
    name: 'Plushie',
    description: 'Soft plush toy style with cozy fabric texture',
    ...
    subStyles: [],
    seoTitle: 'Plushie Genmoji Generator - Soft Toy Style Custom Emojis',
    seoDescription: 'Create plushie-style genmojis with soft toy aesthetics, cozy texture, and warm handcrafted charm.',
    features: [
      'Soft plush toy appearance',
      'Cozy tactile fabric feel',
      'Warm and comforting visual tone',
      'Perfect for wholesome themes and mascots',
    ],
  },
  {
    id: 'keychain',
    name: 'Keychain',
    description: 'Mini keychain charm style with polished details',
    image: '/emojis/keychain.png',
    subStyles: [],
    seoTitle: 'Keychain Genmoji Generator - Mini Charm Custom Emojis',
    seoDescription: 'Create keychain-style genmojis that look like tiny collectible charms with polished surfaces and compact design.',
    features: [
      'Collectible keychain charm aesthetic',
      'Compact and polished design',
      'Great for profile accessories and packs',
      'Clean miniature object styling',
    ],
  },
  {
    id: 'doodle',
    name: 'Doodle',
    description: 'Sketch-like doodle style with playful hand-drawn lines',
    ...
    subStyles: [],
    seoTitle: 'Doodle Genmoji Generator - Sketch Style Custom Emojis',
    seoDescription: 'Create doodle-style genmojis with playful sketch lines, spontaneous charm, and creative hand-drawn personality.',
    features: [
      'Playful sketch-like linework',
      'Creative hand-drawn personality',
      'Loose and expressive visual style',
      'Ideal for casual and artistic communication',
    ],
  },
  {
    id: 'gemstickers',
  ...
  },
  {
    id: 'flower-petals',
    name: 'Flower Petals',
    description: 'Delicate layered flower petals style',
    image: '/emojis/flower-petals.png',
    subStyles: [],
    seoTitle: 'Flower Petals Genmoji Generator - Floral Artistic Custom Emojis',
    seoDescription: 'Create elegant flower-petals style genmojis with layered petal textures and delicate floral aesthetics.',
    features: [
      'Layered flower petal texture',
      'Elegant and delicate floral look',
      'Soft natural lighting style',
      'Great for romantic and spring themes',
    ],
  },
] as const;
