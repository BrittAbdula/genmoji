...
export async function getEmojis(
  ...
  const { model, category, color, sort, isIndexable, hasInteractions } = options || {};
  ...
  if (hasInteractions !== undefined) url.searchParams.set('has_interactions', hasInteractions.toString());
